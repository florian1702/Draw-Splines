...
public class Matrix {
	...
	public static float[][] matMult(float[][] matrix1, float[][] matrix2) {
		...
		if (m != matrix1[0].length)
			...
			for (int i = 0; i < n; i++) { // für alle Spalten von matrix2 und matrix3
				for (int j = 0; j < l; j++) { // für alle Zeilen von matrix1 und matrix3
					matrix3[j][i] = (float) 0.0;
					for (int k = 0; k < m; k++) { // summiere für alle Spalten von matrix1 (Zeilen von Matrix2)
